...
class VideoEncoder(nn.Module):
    ...
    def forward(self,x):
        out_1 = self.lipembeddingextractor(x)
...
class Separation(nn.Module):
    def __init__(self,):
        ...
        self.project = nn.Conv1d(256*3, 256, 1,1)  
...
class AVConvTasNet(nn.Module):
    ...
    def __init__(self,):
        super(AVConvTasNet,self).__init__()
        ...
        self.visualencoder.lipembeddingextractor.load_state_dict(torch.load('../pretrainedmodel/visual_frontend.pt'))
    ...
    def forward(self,audio,video):
        ...
        video_emb = self.visualencoder(video)
...
if __name__ == '__main__':
    model = AVConvTasNet()
    # model.load_state_dict(torch.load('/Work21/2020/lijunjie/AV_ConvTasNet/pretrained_videoencoder/visual_frontend.pt'))
    
    # model = VisualNet()
    # model = model.cuda()


    # video = torch.randn((1,1,37,112,112))
    # video = video.cuda()
